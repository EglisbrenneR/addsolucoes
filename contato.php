...
<head>
    <meta charset="utf-8">
    <title>Add Soluções - Contato</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Contate-nos</h1>
        ...
        <div class="container py-5">
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="ps-4">
                            ...
                            <h4 class="text-primary mb-0">+55 (88) 3531-4191</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.4s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">Envie um e-mail para obter um orçamento gratuito</h5>
                            <h4 class="text-primary mb-0">add@addsolucoes.com</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.8s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">Visite nossa loja</h5>
                            <h5 class="text-primary mb-0">R. Manoel Inácio de Lucena, 451 - Centro, Brejo Santo - CE</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row g-5">
                ...
                <form action="enviar_email.php" method="POST">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <input type="text" class="form-control border-0 bg-light px-4" placeholder="Seu Nome" name="nome" required style="height: 55px;">
                        </div>
                        <div class="col-md-6">
                            <input type="email" class="form-control border-0 bg-light px-4" placeholder="Seu E-mail" name="email" required style="height: 55px;">
                        </div>
                        <div class="col-12">
                            <input type="text" class="form-control border-0 bg-light px-4" placeholder="Assunto" name="assunto" required style="height: 55px;">
                        </div>
                        <div class="col-12">
                            <textarea class="form-control border-0 bg-light px-4 py-3" rows="4" placeholder="Mensagem" name="mensagem" required></textarea>
                        </div>
                        <div class="col-12">
