                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <p class="mb-0">R. Manoel Inácio de Lucena, 451 - Centro, Brejo Santo - CE</p>
                        </div>
                        <div class="d-flex mb-2">
                            <i class="bi bi-envelope-open text-primary me-2"></i>
                            <p class="mb-0">add@addsolucoes.com</p>
                        </div>
                        <div class="d-flex mb-2">
                            <i class="bi bi-telephone text-primary me-2"></i>
                            <p class="mb-0">+55 (88) 3531-4191</p>
                        </div>
        ...
        <div class="row justify-content-end">
            <div class="col-lg-8 col-md-6">
                <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                     <a>Todos os direitos Resevado</a>
                    <p class="mb-0">&copy; <a class="text-white border-bottom" href="index.php">Add Soluções</a>
                    
                    <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                    Distribuido por: <a class="border-bottom" href="index.php" target="_blank">Add Solucões</a>
                </div>
            </div>
        </div>
    </div>
