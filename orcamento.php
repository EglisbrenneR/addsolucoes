...
<head>
    <meta charset="utf-8">
    <title>Add Soluções - Orçamentos</title>
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="orcamento.php" class="dropdown-item active">ORÇAMENTOS</a>
                        </div>
                    </div>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Orçamento Gratuito</h1>
                    <a href="" class="h5 text-white">Inicio</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Orçamento Gratuito</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Precisa de um orçamento grátis? Sinta-se à vontade para nos contatar</h1>
                    </div>
                    <div class="row gx-3">
                    ...
                    <p class="mb-4">Acreditamos que a transparência é fundamental em todas as nossas relações, por isso, mantemos uma comunicação aberta e honesta com nossos clientes. Estamos sempre disponíveis para esclarecer dúvidas, ouvir sugestões e resolver qualquer eventualidade que possa surgir.</p>
                ...
                <div class="col-lg-5">
                    ...
                    <form action="enviar_orcamento.php" method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <select name="servico" class="form-select bg-light border-0" style="height: 55px;" required>
                                ...
                                <div class="col-12">
                                    <textarea name="mensagem" class="form-control bg-light border-0" rows="3" placeholder="Mensagem" required></textarea>
                                </div>
                                <div class="col-12">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            if (mail($to, $subject, $emailContent, $headers)) {
                                echo "<p style='color: green;'>Orçamento enviado com sucesso!</p>";
                            } else {
                                echo "<p style='color: red;'>Falha ao enviar o orçamento. Tente novamente.</p>";
                            }
                        }
                        ?>
                    </div>
