...
<body>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">ADD SOLUÇÕES</h1>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">A melhor solução de TI,  com 7 anos de experiência e excelência no mercado.</h1>
                    </div>
                    <p class="mb-4">Fundada em 2017, a Add Soluções nasceu com o propósito de transformar a forma como empresas de Brejo Santo - CE e região utilizam a tecnologia. Idealizada por especialistas em tecnologia, nossa missão é oferecer soluções inovadoras que não apenas automatizem processos, mas também impulsionem resultados tangíveis para nossos clientes. Com ferramentas de TI de ponta, ajudamos a otimizar operações, aumentar a eficiência e tornar os objetivos das empresas mais alcançáveis e visíveis.</p>
                    <div class="row g-0 mb-3">
                        <div class="col-sm-3 wow zoomIn" data-wow-delay="0.2s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Excelência</h5>
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Tecnologia</h5>
                        </div>
                        <div class="col-sm-3 wow zoomIn" data-wow-delay="0.2s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Confiabilidade</h5>
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Eficiência</h5>
                        </div>
                        <div class="col-sm-3 wow zoomIn" data-wow-delay="0.4s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Resultados</h5>
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Automação</h5>
                        </div>
                        <div class="col-sm-3 wow zoomIn" data-wow-delay="0.4s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Soluções</h5>
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Inovação</h5>
                        </div>
                    </div>
                    ...
                    <a href="orcamento.php" class="btn btn-primary py-3 px-5 mt-3 wow zoomIn" data-wow-delay="0.9s">Solicite um Orçamento</a>
                </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">Soluções de TI personalizadas para você o seu negócio </h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">Cyber Segurança</h4>
                        <p class="m-0">A cibersegurança, ou segurança cibernética, refere-se às práticas, tecnologias e processos que protegem redes, sistemas e dados contra ataques, danos ou acessos não autorizados.</p>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">Aplicações comerciais</h4>
                        <p class="m-0">As aplicações comerciais são utilizadas por empresas para otimizar processos, aumentar a eficiência e melhorar a gestão em diversas áreas.</p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <p class="m-0">Nosso suporte técnico auxilia usuários de tecnologia a resolver problemas com hardware, software e outros dispositivos eletrônicos.</p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">Redes de computadores</h4>
                        <p class="m-0">Somos especialistas em redes de computadores, oferecendo soluções completas e personalizadas para atender às necessidades específicas de cada cliente.</p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-3">Softwares de automação</h4>
                        <p class="m-0">Oferecemos uma ampla gama de softwares projetados para atender às necessidades específicas de diferentes setores.</p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div class="position-relative bg-primary rounded h-100 d-flex flex-column align-items-center justify-content-center text-center p-5">
                        <h3 class="text-white mb-3">Ligue para nós para obter uma cotação</h3>
                        <p class="text-white mb-3">Precisa de um orçamento grátis?</p>
                        <h2 class="text-white mb-0">+55 (88) 3531-4191</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Pricing Plan Start -->
    <?php
        include "loja/indexcarrosel.php";
    ?>
    <!-- Pricing Plan End -->
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Precisa de um orçamento gratuito? Entre em contato conosco, será um prazer ajudar!</h1>
                    </div>
                    <div class="row gx-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                            <h5 class="mb-4"><i class="fa fa-reply text-primary me-3"></i>Responder dentro de 24 horas</h5>
                        </div>
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                            <h5 class="mb-4"><i class="fa fa-phone text-primary me-3"></i>Suporte telefônico 24 horas</h5>
                        </div>
                    </div>
                    <p class="mb-4">Acreditamos que a transparência é a base de todas as nossas relações. Por isso, cultivamos uma comunicação aberta e honesta com nossos clientes. Estamos sempre à disposição para esclarecer dúvidas, ouvir sugestões e solucionar qualquer questão que possa surgir.</p>
                    ...
                    <div class="bg-primary rounded h-100 d-flex align-items-center p-5 wow zoomIn" data-wow-delay="0.9s">
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-dark w-100 py-3" type="submit">Enviar Orçamento</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-4 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">TESTEMUNHAS</h5>
                <h1 class="mb-0">O que nossos clientes dizem sobre nossos serviços</h1>
            </div>
