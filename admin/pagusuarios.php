      ...
      <div class="main-panel">
        ...
        <div class="container">
          <div class="page-inner">
            ...
            >
              <div>
              <h3 class="fw-bold mb-3"> PAGINA DE USUARIOS CADASTRADOS</h3>
              <h2 class="op-7 mb-2">BEM-VINDO</h2>
              </div>
              <div class="ms-md-auto py-2 py-md-0">
                <a href="FORMULARIO.php" class="btn btn-label-info btn-round me-2">CADASTRAR USUARIO</a>
                ...
                <div class="card card-stats card-round">
                  ...
                  <div class="card">
                    <div class="card-header">
                      <div class="card-title">Tabela de Usuarios</div>
                    </div>
                    <div class="card-body">
