<?php
    ...
    {
        unset($_SESSION['usuario']['usuario']['nome']);
                        ...
                        <div class="card card">
                          ...
                          <div class="card-body">
                            <form method="post"  action="configproduto.php" enctype="multipart/form-data">
                              <div class="row">
                                ...
                                <div class="col-sm-8">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input value="<?php echo $nome; ?>" type="text" name="nome" class="form-control" placeholder="Ex: VENDEDOR EXTERNO" required>
                                  </div>
                                </div>
                                <div class="col-sm-8">
                                  <!-- text input -->
                                  <div class="form-group">
                                    ...
                                    <input value="<?php echo $codigo; ?>" type="text" name="codigo" class="form-control" placeholder="DESCREVA SOBRE A VAGA ">
                                  </div>
                                </div>
                                <div class="col-sm-8">
                                  <div class="form-group">
                                    <label>LOCALIZAÇÃO</label>
                                    <input value="<?php echo $descricao; ?>" type="text" name="descricao" class="form-control" placeholder=" Ex: BREJO SANTO">
                                  </div>
                                </div>
                                <div class="col-sm-8">
                                  <div class="form-group">
                                    <label>TIPO DE CONTRATO</label>
                                    <input value="<?php echo $descricao; ?>" type="text" name="descricao" class="form-control" placeholder=" Ex: CLT ou PJ">
                                  </div>
                                </div>
                                <div class="col-sm-8">
                                  <div class="form-group">
                                    <label>FAIXA SALARIAL</label>
                                    <input value="<?php echo $descricao; ?>" type="text" name="descricao" class="form-control" placeholder=" Ex: OPICIONAL">
                                  </div>
                                </div>
                              ...
                              <div class="col-sm-6">
                               <div class="form-group">
                                <input type="submit" name="enviar" class="btn btn-block btn-outline-success btn-lg" value="CADASTRAR">
                                </td>
                            </form>
